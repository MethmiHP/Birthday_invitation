...
export default function RSVPForm() {
    ...
    if (submitted) {
        return (
            <motion.div
                ...
                className="bg-white/95 backdrop-blur-lg p-10 pb-14 rounded-[2.5rem] border-2 border-[#b38954]/20 text-center text-[#2c2724] shadow-[0_15px_40px_rgba(179,137,84,0.12)] max-w-lg mx-auto font-serif relative"
            >
    ...
    return (
        <motion.form
            ...
            className="bg-white/95 backdrop-blur-lg p-10 pb-14 rounded-[2.5rem] border-2 border-[#b38954]/20 space-y-6 text-[#2c2724] max-w-lg mx-auto shadow-[0_15px_40px_rgba(179,137,84,0.12)] font-serif relative"
        >
            {/* Inner Gold Frame Border */}
            <div className="absolute inset-3 border-4 border-double border-[#b38954]/30 rounded-[1.8rem] pointer-events-none z-10" />
